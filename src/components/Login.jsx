...
const Login = () => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      alert('Login susseccfully with Google ')
      navigate("/")
    } catch (error) {
      console.log(error);
      alert("Login failed");
  ...
  return (
    <div className="h-[calc(100vh - 120px)] flex justify-center items-center">
      <div className="w-full max-w-sm mx-auto bg-white shadow-lg rounded px-8 pt-6 pb-8 mb-4">
        <h2 className="text-2xl font-bold mb-4 text-center text-secondary">Please Login</h2>
        ...
        <div className="mt-4">
          <button onClick={handleGoogleSignIn} className="w-full flex flex-wrap gap-1 items-center justify-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none">
